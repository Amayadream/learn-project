    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="#"><i class="fa fa-briefcase"></i><span>资源管理</span></a></li>
                <li class="treeview"><a href="#"><i class="fa fa-briefcase"></i><span>组织机构</span> <i class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">
                        <li><a href="#"><i class="fa fa-diamond"></i>组织管理</a></li>
                        <li><a href="#"><i class="fa fa-user-secret"></i>角色管理</a></li>
                        <li><a href="#"><i class="fa fa-users"></i></i>用户管理</a></li>
                    </ul>
                </li>
            </ul>
            <!-- Menu End -->
