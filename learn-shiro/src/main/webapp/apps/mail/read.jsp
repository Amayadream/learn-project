                    ...
                    <div class="box box-primary">
                        ...
                        <span class="mailbox-attachment-size">
                          ...
                          <a href="#" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
                                ...
                                <li>
                                    <span class="mailbox-attachment-icon has-img"><img src="${ctx}/static/img/photo1.png" alt="Attachment"></span>
                                    <div class="mailbox-attachment-info">
                        ...
                        <span class="mailbox-attachment-size">
                          ...
                          <a href="#" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
                                ...
                                <li>
                                    <span class="mailbox-attachment-icon has-img"><img src="${ctx}/static/img/photo2.png" alt="Attachment"></span>
                                    <div class="mailbox-attachment-info">
